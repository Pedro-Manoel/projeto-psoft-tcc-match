...
public class AppEventController {
    ...
    public void handleEvent(SolicitacaoOrientacaoTccCriadaEvent solicitacaoOrientacaoTccCriadaEvent) {
        ...
        email.setMensagem(
                String.format(
                        "Um aluno acaba de solicitar uma orientação de TCC em um tema de TCC cadastrado por você." +
        ...
        email.setData(new Date());
        emailService.enviarEmail(solicitacaoOrientacaoTccCriadaEvent.getProfessor(), email);
    }
}